#include "intrin.h"
#include "../impl/struct.h"
#include "../impl/structures.hpp"
#include "../impl/crt.h"
namespace crt
{
    INT klower(int c)
...
namespace modules
{
    ...
    auto write_address(uintptr_t address, void* buffer, SIZE_T size, bool restore) -> bool
    {
        ...
        auto Mdl = IoAllocateMdl(reinterpret_cast<void*>(address), size, false, false, (PIRP)false);

        MmProbeAndLockPages(Mdl, KernelMode, IoReadAccess);

        auto Mapping = MmMapLockedPagesSpecifyCache(Mdl, KernelMode, MmNonCached, nullptr, false, NormalPagePriority);
